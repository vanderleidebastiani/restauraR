...
The `cerrado` is a toy dataset containing only 50 sampled species of the full cerrado dataset. The original data set includes traits of 483 species used in restoration projects in the savannas in the Cerrado biome. This toy dataset is designed to illustrate the main features of the resbiota package, including scenarios with reference sites and restoration sites.
