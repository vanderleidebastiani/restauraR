#' @title restauraR - Restore Ecosystem Services and Biodiversity Through Trait-based Approaches
#' @name restauraR-package
#' @docType package
#' @aliases restauraR
#' @encoding UTF-8
#' @import knitr
...
#' vignettes accessible via \code{browseVignettes("restauraR")}.
