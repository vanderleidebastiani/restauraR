...
#' @param cwv vector vector with trait names to calculate Community Weighted Variance. One CWV is calculated for each trait.
...
#' @examples
#' @export
comSimulation2 <- function(trait, ava, it, rich, cwm, cwv, rao, cost, dens, ref,
                          min_p, phi = 1){
  # OUTPUTS ###############################################
