                                              ...
                                              shiny::tabPanel(i18n$t("Details"),
                                                              shiny::fluidRow(
                                                                ...
                                                                shiny::column(width = 12,
                                                                              ...
                                                                              htmltools::p(i18n$t("The function in compute tab, subtab standardize parameters, allows the standardisation of the calculated parameters. Two methods are available: 'max', which divides the values by the maximum, and 'standardise', which scales the calculated parameters to zero mean and unit variance. For example, the 'max' method is useful to scale dissimilarity results by scaling the values in ranges from 0 (no dissimilarity) to 1 (maximum dissimilarity).")),
                                                                              ...
                                                                              htmltools::p(i18n$t("High values of alpha multifunctionality can be a preferable criterion for selection, meaning that, for each restoration site, the selection is performed in order to return a solution with the highest number of ecosystem functions recovered.")),
                                                                              htmltools::p(htmltools::strong(i18n$t("Visualization"))),
                                                                              htmltools::p(i18n$t("The results visualization functions are auxiliary to checking parameters in reference sites, analyzing the distribution of functional parameters in simulated communities and showing final solutions of selected species composition.")),
                                                                              htmltools::p(i18n$t("The function in the view tab allows the visualisation of basic results using scatter plots to show the trade-offs between several parameters, restoration costs, species richness and any calculated functional parameter. This visualisation includes all simulated communities and allows includes also observed relations in reference sites.")),
                                                                              htmltools::p(i18n$t("The function in the view multifunctionality tab allows visualize the multifunctionality sets creating a graphical representation of the number of sites where each function has been restored, and the number of sites where combinations of functions were restored.")),
                                                                ...
                                                                shiny::column(width = 8,
                                                                              ...
                                                                              shinyWidgets::pickerInput(inputId = "cwmSimInput",
                                                                                                        ...
                                                                                                        label = htmltools::p(i18n$t("Traits to Community Weighted Mean"), 
                                                                                                                             shiny::actionButton("cwmSimInputInfo",
                                                                                                                                                 label = "",
                                                                                                                                                 icon = shiny::icon("info"),
                                                                                                                                                 style = 'padding:3px; font-size:60%')),
                                                                                                        choices = NULL,
                                                                              ...
                                                                              shinyWidgets::pickerInput(inputId = "raoSimInput",
                                                                                                        ...
                                                                                                        label = htmltools::p(i18n$t("Traits to Rao Quadratic Entropy"), 
                                                                                                                             shiny::actionButton("raoSimInputInfo",
                                                                                                                                                 label = "",
                                                                                                                                                 icon = shiny::icon("info"),
                                                                                                                                                 style = 'padding:3px; font-size:60%')),
                                                                                                        choices = NULL,
                                                                              ...
                                                                              shinydashboardPlus::box(id = 'box', width = 8, title = "xxx", headerBorder = FALSE,
                                                                                                      collapsible = TRUE,
                                                                                                      collapsed = FALSE,
                                                                              ...
                                                                              shinydashboardPlus::box(id = 'box', width = 12, title = "xxx", headerBorder = FALSE,
                                                                                                      shiny::conditionalPanel(condition = "(input.methodSimInput == 'Individuals')",
                            ...
                            shiny::fluidRow(
                              shiny::column(width = 12,
                                            shiny::tabsetPanel(
                                              ...
                                              shiny::tabPanel(i18n$t("Standardize parameters"), 
                                                              shiny::fluidRow(
                                                                htmltools::br(),
                                                                shiny::column(width = 8,
                                                                              ...
                                                                              shinyWidgets::pickerInput(inputId = "stanComParInput",
                                                                                                        ...
                                                                                                        label = htmltools::p(i18n$t("Parameters to standardized"), 
                                                              ...
                                                              shiny::fluidRow(
                                                                ...
                                                                shiny::column(width = 8,
                                                                              ...
                                                                              shinyWidgets::pickerInput(inputId = "testsDetSelInput",
                                                                                                        ...
                                                                                                        label = htmltools::p(i18n$t("Parameters to deterministic selection"), 
                                                                                                                             shiny::actionButton("testsDetSelInputInfo",
                                                                                                                                                 label = "",
                                                                                                                                                 icon = shiny::icon("info"),
                                                                                                                                                 style = 'padding:3px; font-size:60%')),
                                                                                                        choices = NULL,
                                                                              ...
                                                                              shinyWidgets::pickerInput(inputId = "testsHieSelInput",
                                                                                                        ...
                                                                                                        label = htmltools::p(i18n$t("Parameters to hierarchical selection"), 
                                                                                                                             shiny::actionButton("testsHieSelInputInfo",
                                                                                                                                                 label = "",
                                                                                                                                                 icon = shiny::icon("info"),
                                                                                                                                                 style = 'padding:3px; font-size:60%')),
                                                                                                        choices = NULL,
