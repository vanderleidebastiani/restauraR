...
#' \describe{
#'   \item{traits}{A data frame object with traits data. The data frame contains two traits: `Zoochory` and `WoodDensity`. Furthermore, the column `EcologicalSuccession` indicates the successional groups of species and the column `relativeAbundance` indicates the species abundances in the regional pool. }
#'   \item{referenceSites}{A matrix contains raw abundances for 60 species in the 2 reference sites. The species are arranged as columns and sites in rows.}
#'   \item{restorationSitesComp}{A matrix contains raw abundances for 19 species in the 2 restoration sites. The species are arranged as columns and sites in rows.}
